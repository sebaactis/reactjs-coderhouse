  ...
  if (orderInfo) {
    ...
    return (
      <div className="pedidoConteiner">
        <h1>
          Su pedido{" "}
          <span style={{ color: "green", fontWeight: "bold" }}>{order}</span>{" "}
          es:
        </h1>
        <div className="datosPersonalesOrden">
          ...
          <p>
            {" "}
            <span style={{ fontWeight: "bold" }}> Nombre: </span> {nombre}{" "}
          </p>
          <p>
            {" "}
            <span style={{ fontWeight: "bold" }}> Apellido: </span> {apellido}{" "}
          </p>
          <p>
            {" "}
        ...
        <p>
          {" "}
          <span style={{ fontWeight: "bold" }}> Precio total a pagar: </span> $
          {total}
        </p>
        <button className="btn btn-success" onClick={resetOrder}>
          Consultar por otro pedido
        </button>
      </div>
    );
  }
  ...
  return (
    <form className="divEstadoPedido" onSubmit={pedirDatos}>
      ...
      <input
        ...
        value={order}
      />
      <button className="buttonFormEstadoPedido btn btn-success">
        {" "}
        Enviar{" "}
      </button>
    </form>
